...
function getCreditsHTML() {
	return new Promise(resolve => {
		...
		let text = 
		'<div class="crditsContainer">' +
		
		'<h1 class="greeting">Credits</h1>' +
		'<h1 class="credits"> <a class="credits" href="https://github.com/DEVTomatoCake/dashboard/graphs/contributors">Contributors</a></h1>' +
		// hier könnte man mit der Github api arbeiten, aber das ist mir gerade zu doof .-.
		'<div class="creditsUser">' +
        '<h3 class="credits">TomatoCake </h3>' +
        '<a href="https://github.com/DEVTomatoCake" target="_blank"><i aria-hidden="true" class="fab fa-github creditsMedia" title="Github (DEVTomatoCake)"></i></a>' +
        '<a href="https://discord.com/users/581146486646243339" target="_blank"><i aria-hidden="true" class="fab fa-discord creditsMedia " title="Discord (TomatoCake#2691)"></i></a>' +
        '<br>' +
		'<img class="creditsIMG" src="https://cdn.discordapp.com/avatars/581146486646243339/a_82b44d55d78047e2e4859c00f594793b.png" alt="could not load image" onerror="this.src = \'https://github.com/FuntyGithub/credits-website/blob/main/assets/user.png?raw=true\'">' +
     	'</div>' +

		'<div class="creditsUser">' +
		'<h3 class="credits">booky10</h3>' +
		'<a href="https://github.com/booky10" target="_blank"><i aria-hidden="true" class="fab fa-github creditsMedia" title="Github (booky10)"></i></a>' +
		'<a href="https://discord.com/users/324648170011492352" target="_blank"><i aria-hidden="true" class="fab fa-discord creditsMedia " title="Discord (booky10#6666)"></i></a>' +
		'<br>' +
		'<img class="creditsIMG" src="https://cdn.discordapp.com/avatars/324648170011492352/a_9ea5c63aeca190b10c0f505ce15b1984.png" alt="could not load image" onerror="this.src = \'https://github.com/FuntyGithub/credits-website/blob/main/assets/user.png?raw=true\'">' +
		'</div>' +

		'<div class="creditsUser">' +
        '<h3 class="credits">Funty</h3>' +
        '<a href="https://github.com/FuntyGithub" target="_blank"><i aria-hidden="true" class="fab fa-github creditsMedia" title="Github (FuntyGithub)"></i></a>' +
        '<a href="https://discord.com/users/417258282479124480" target="_blank"><i aria-hidden="true" class="fab fa-discord creditsMedia " title="Discord (Funty#8818)"></i></a>' +
        '<br>' +
		'<img class="creditsIMG" src="https://cdn.discordapp.com/avatars/417258282479124480/36b2a0befd431560167ff1c7acd8dead.png" alt="could not load image" onerror="this.src = \'https://github.com/FuntyGithub/credits-website/blob/main/assets/user.png?raw=true\'">' +
     	'</div>' +


		 '<h1 class="credits">Websiten-Design</h1>' +
		 '<div class="creditsUser">' +
		 '<h3 class="credits">Bookie0  </h3>' +
		 '<a href="https://bookie0.repl.co/" target="_blank"><i aria-hidden="true" class="fas fa-link creditsMedia " title="bookie0.repl.co"></i></a>' +
		 '<br>' +
		 '<img class="creditsIMG" src="?" alt="could not load image" onerror="this.src = \'https://github.com/FuntyGithub/credits-website/blob/main/assets/user.png?raw=true\'">' +
		  '</div>' +
 
		 '<div class="creditsUser">' +
		 '<h3 class="credits">Elliana</h3>' +
		 '<a href="https://discords.com/" target="_blank"><i aria-hidden="true" class="fas fa-link creditsMedia " title="discords.com"></i></a>' +
		 '<br>' +
		 '<img class="creditsIMG" src="?" alt="could not load image" onerror="this.src = \'https://github.com/FuntyGithub/credits-website/blob/main/assets/user.png?raw=true\'">' +
		 '</div>' +
