...
function pageLoad(page = "") {
	...
	if (username) {
		...
		document.getElementById("hoverdropdown-content").innerHTML = '<a href="/logout/" translation="global.logout">Abmelden</a><a href="/dashboard/user/" translation="global.viewdataexport">Eigene Daten ansehen</a>';
